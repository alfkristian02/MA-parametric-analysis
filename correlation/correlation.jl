...
# gather data
files::Vector{String} = ["heart_13_04212141.csv", "letter_16_04251835.csv", "letter_16_04251835.csv", "nk_K2_04230937.csv", "nk_K9_04251941.csv", "nk_K16_04251941.csv"]
included_columns::Vector{String} = ["ds", "population_size", "number_of_generations", "crossover_probability", "mutation_rate", "ls_p_value", "ls_max_steps", "avg_ga_improvement", "avg_ls_improvement", "best_found", "fitness_function_accesses"]
...
for col in cols_to_fix
    ...
    replace!(numeric_df[!, col], NaN => 0.0)
end
